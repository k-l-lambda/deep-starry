...
the true pairing must beat it. MEASURED: matchrate 0.717 vs 0.099, winning on 100/100 files. That gap
is what makes the rest evidence rather than decoration.
...
def check_wrong_pair_control (src_dir, tgt_dir, names, src_window):
	...
	MEASURED over 100 files: matchrate 0.717 true vs 0.099 decoy, prior +0.460 vs -0.189, and the true
