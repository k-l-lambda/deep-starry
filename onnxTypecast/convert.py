...
# origin from: https://github.com/aadhithya/onnx-typecast
...
def convert_model_to_int32 (model_path: str, out_path: str):
	...
	"""
	logging.info("ONNX INT64 --> INT32 Converter")
	...
	logging.info("Converting INT64 model params to INT32...")
	...
	logging.info("Creating new int32 model...")
	...
	logging.info(f"Saving converted model as: {out_path}")

	onnx.save_model(model_int32, out_path)

	logging.info(f"Done Done London. 🎉")


if __name__ == '__main__':
	convert_model_to_int32(sys.argv[1], sys.argv[2])
